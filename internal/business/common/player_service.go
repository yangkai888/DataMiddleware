...
type PlayerService struct {
	...
	authService *authInfra.JWTService
}

// NewPlayerService 创建玩家服务
func NewPlayerService(dao daoPkg.DAO, log loggingInfra.Logger, authService *authInfra.JWTService) *PlayerService {
...
func (s *PlayerService) convertToAPITypes(player *daoPkg.Player) *types.Player {
	return &types.Player{
